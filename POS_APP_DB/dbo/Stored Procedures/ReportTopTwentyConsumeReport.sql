...
CREATE Proc [dbo].[ReportTopTwentyConsumeReport]--'7/1/2013 12:00:00 AM','9/30/2013 12:00:00 AM' ,'Admin'
@From as datetime,
@To as Datetime,
@Login as nvarchar(max)
as
Declare @ReportName as nvarchar(max);
set @ReportName='Top Twenty Consumable Item';
select top (20) isnull(sum(pds.IngredientQty),0) as ConsumeQty,  CONVERT(VARCHAR(11),@From,106) as [From],CONVERT(VARCHAR(11),@To,106) as [To], 
