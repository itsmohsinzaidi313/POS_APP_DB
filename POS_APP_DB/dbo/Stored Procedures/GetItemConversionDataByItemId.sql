CREATE Proc [dbo].[GetItemConversionDataByItemId]--46
@ItemId as int
as
...
--ii.PurFactor/ii.IssFactor as PackingInvConversion ,
--ii.IssFactor/ii.RecpFactor as InvRecepieConversion,
ii.IssFactor as PackingInvConversion ,
ii.RecpFactor as InvRecepieConversion
from Item i 
