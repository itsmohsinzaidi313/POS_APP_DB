...
CREATE Proc [dbo].[ReportCategoryDateWiseDemandSheetStore]
@COId as int,
@From as datetime,
@To as Datetime,
...
set @ReportName='Demand Sheet Store Category Wise';
...
where dm.Date between @From and @To and dm.COId=@COId 
and dm.SId=@SId
