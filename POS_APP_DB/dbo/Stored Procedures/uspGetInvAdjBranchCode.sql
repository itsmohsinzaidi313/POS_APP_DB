create proc [dbo].[uspGetInvAdjBranchCode] 
@BRId as int
as
...
set @TableName = 'InvAdjMaster_Branch';
set @VoucherPara= 'ADJ-';

SET @SQLString= 'select @NewVoucher = isnull(Max(AdjNo),0) from '+@TableName+' where BRId=''' + CONVERT(VARCHAR(10),@BRId, 101) + ''' ';
