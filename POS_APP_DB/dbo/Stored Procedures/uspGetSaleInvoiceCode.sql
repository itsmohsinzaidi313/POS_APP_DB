create proc [dbo].[uspGetSaleInvoiceCode] 
as
...
set @TableName = 'SaleInvoiceMaster';
set @VoucherPara= 'SALE-';
SET @SQLString= 'select @NewVoucher = isnull(Max(SaleInvoiceNo),0) from '+@TableName+' ';
