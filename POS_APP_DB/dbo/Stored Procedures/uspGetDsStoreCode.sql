CREATE proc [dbo].[uspGetDsStoreCode]-- '1'
@SId as int
as
...
set @TableName = 'DemandSheetMaster_Store';
set @VoucherPara= 'DO-';
SET @SQLString= 'select @NewVoucher = isnull(Max(DSNo),0) from '+@TableName+' where SId=''' + CONVERT(VARCHAR(10),@SId, 101) + ''' ';
