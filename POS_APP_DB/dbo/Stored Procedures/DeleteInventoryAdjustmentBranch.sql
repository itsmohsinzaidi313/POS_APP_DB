create Proc [dbo].[DeleteInventoryAdjustmentBranch] 
@AdjBRId as int,
...
set @MasterQuery='Delete from '+@Master+' where AdjBRId= ''' + CONVERT(VARCHAR(10),@AdjBRId, 101) + ''' and AdjNo= ''' + CONVERT(VARCHAR(10),@AdjNo, 101) +''' '
exec sp_executesql @MasterQuery
Commit
set @DetailQuery='Delete from '+@Detail+' where AdjBRId= ''' + CONVERT(VARCHAR(10),@AdjBRId, 101) + ''' '
