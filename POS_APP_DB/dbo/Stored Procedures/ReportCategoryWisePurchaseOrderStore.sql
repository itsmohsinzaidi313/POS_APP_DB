...
CREATE Proc [dbo].[ReportCategoryWisePurchaseOrderStore]--'76','6/26/2013 12:00:00 AM','7/7/2013 12:00:00 AM','Admin','28'
@COId as int,
@From as datetime,
@To as Datetime,
...
set @ReportName='Purchase Order Store Category wise';
