...
CREATE Proc [dbo].[ReportDeptWiseDemandSheetBranch]--'6/26/2013 12:00:00 AM','7/28/2013 12:00:00 AM','Admin','30'
@From as datetime,
@To as Datetime,
...
set @ReportName='Demand Sheet Branch Department Wise';
...
inner join Split(@DeptId,',') sp on sp.items = d.id
