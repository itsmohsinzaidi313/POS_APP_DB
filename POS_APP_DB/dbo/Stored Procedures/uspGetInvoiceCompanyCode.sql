CREATE proc [dbo].[uspGetInvoiceCompanyCode] 
as
...
set @TableName = 'InvoiceMaster_CompanyNew';
set @VoucherPara= 'INV-';
SET @SQLString= 'select @NewVoucher = isnull(Max(InvoiceNo),0) from '+@TableName+' ';
