...
CREATE Proc [dbo].[ReportItemWisePurchaseReturnReport]--'6/26/2013 12:00:00 AM','12/31/2013 12:00:00 AM','Admin','134'
@From as datetime,
@To as Datetime,
...
set @ReportName='Purchase Return Item wise';
...
prd.Qty as ReturnQty 
from PurchaseReturnMasterNew prm
inner join PurchaseReturnDetailNew prd on prm.PRId=prd.PRId
...
inner join GRNMaster gm on gm.GRNId=prm.GRNId
...
group by prm.Date,prm.PRNo, 
--ic.InvoiceNo,
gm.GRNo,v.Vendor,c.Category,sc.Subcategory,i.Item,prd.TotalPackage,
prd.PcsPerPackage,prd.PackageId,U.Unit,
--dsm.DSNo,
--ic.InvoiceNo,idc.Qty,
prm.Discount,
--ps.PONo,
Un.Unit,iu.IssFactor,iu.PurFactor,Uni.Unit,
