...
CREATE Proc [dbo].[ReportCategoryWisePurchaseReport]--'6/26/2013 12:00:00 AM','7/29/2013 12:00:00 AM','Admin','30'
@From as datetime,
@To as Datetime,
...
set @ReportName='Goods Purchasing Category wise';
select CONVERT(VARCHAR(11),@From,106) as [From],CONVERT(VARCHAR(11),@To,106) as [To],@Login as LoginUser,im.Date,gm.GRNo,v.Vendor,@ReportName as store,c.Category,sc.Subcategory,i.Item,
