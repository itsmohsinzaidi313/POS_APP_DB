...
create proc [dbo].[GetProductionCodeDepartment] 
as
...
set @TableName = 'ProductionMasterDepartment';
set @VoucherPara= 'PD-';
SET @SQLString= 'select @NewVoucher = isnull(Max(PRNo),0) from '+@TableName+' ';
