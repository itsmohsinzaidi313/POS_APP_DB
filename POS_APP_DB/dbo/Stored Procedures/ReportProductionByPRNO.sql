CREATE proc [dbo].[ReportProductionByPRNO]--'7/10/2013 12:00:00 AM','7/10/2013 12:00:00 AM','admin','15'
@PRNO as nvarchar(50),
@Login as nvarchar(max)
as
Declare @ReportName as nvarchar(max);
set @ReportName='Production Report PRNo wise';
select @Login as LoginUser,pm.Date,pm.PRNo,@ReportName as ReportName,c.Category,sc.Subcategory,i.Item,
