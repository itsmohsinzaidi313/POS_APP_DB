...
CREATE Proc [dbo].[ReportItemDateWisePurchaseOrderStore]--'76','6/26/2013 12:00:00 AM','6/26/2013 12:00:00 AM','Admin','10'
@COId as int,
@From as datetime,
@To as Datetime,
...
set @ReportName='Purchase Order Store Item wise';
select CONVERT(VARCHAR(11),@From,106) as [From],CONVERT(VARCHAR(11),@To,106) as [To],@Login as LoginUser,pm.Date,pm.PONo,v.Vendor,@ReportName as store,c.Category,sc.Subcategory,i.Item,
...
where pm.Date between @From and @To and pm.COId=@COId --and ipl.BRId=0 and ipl.SId>0
and pm.SId=@SId
...
--ipl.ParLevel,
ps.Rate,ps.Qty,iu.IssFactor,U.Unit,i.ItemId
