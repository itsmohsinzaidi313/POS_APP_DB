...
CREATE Proc [dbo].[ReportGRNoWiseReceivingReportBranch]--'6/26/2013 12:00:00 AM','6/29/2013 12:00:00 AM','Admin','10'
@GRNO as nvarchar(50),
...
where gm.GRNo=@GRNO  and ipl.BRId>0 and ipl.SId=0 and psd.ItemId=gd.ItemId
order by gm.GRNo asc
