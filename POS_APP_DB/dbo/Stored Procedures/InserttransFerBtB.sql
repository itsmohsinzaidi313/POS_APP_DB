...
Create proc [dbo].[InserttransFerBtB]--'7/31/2013','TR-0001','10','1','1','1500','<doc><title ItemId="38" UId="19" Qty="10" Rate="150" TotalPackage="0" PcsPerPackage="0" RatePerPackage="0" Amount="1500"  PackageId="19" /></doc>'
...
(
Date,ItemId,Unit,Qty,Rate,[Type],TROutId,BRId
)
Select
...
Insert into WareHouse_Branch
(
Date,ItemId,Unit,Qty,Rate,[Type],TRInId,BRId
)
Select
@Date, myXML.value('./@ItemId','int'),myXML.value('./@UId', 'int')
, myXML.value('./@Qty', 'decimal(18,2)')
