...
CREATE Proc [dbo].[ReportDateWisePurchaseOrderStore]--'76','6/26/2013 12:00:00 AM','6/26/2013 12:00:00 AM','Admin','10'
@COId as int,
@From as datetime,
@To as Datetime,
...
set @ReportName='Purchase Order Store Date wise';
select CONVERT(VARCHAR(11),@From,106) as [From],CONVERT(VARCHAR(11),@To,106) as [To],@Login as LoginUser,pm.Date,pm.PONo,v.Vendor,@ReportName as store,c.Category,sc.Subcategory,
