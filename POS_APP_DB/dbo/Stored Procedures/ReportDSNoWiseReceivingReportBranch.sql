...
CREATE Proc [dbo].[ReportDSNoWiseReceivingReportBranch]--'6/26/2013 12:00:00 AM','6/29/2013 12:00:00 AM','Admin','10'
@DSNO as nvarchar(50),
...
where dsm.DSNo=@DSNO  and ipl.BRId>0 and ipl.SId=0 and psd.ItemId=gd.ItemId
