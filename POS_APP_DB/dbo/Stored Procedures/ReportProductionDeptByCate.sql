...
create proc [dbo].[ReportProductionDeptByCate]--'7/10/2013 12:00:00 AM','10/10/2013 12:00:00 AM','admin','30'
@From as datetime,
@To as Datetime,
...
set @ReportName='Department Production Report Category wise';
