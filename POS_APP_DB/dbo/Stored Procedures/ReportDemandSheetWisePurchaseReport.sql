...
CREATE Proc [dbo].[ReportDemandSheetWisePurchaseReport]--'6/26/2013 12:00:00 AM','6/26/2013 12:00:00 AM','Admin','28'
@DSNOId as text,
...
idc.PcsPerPackage,idc.PackageId,U.Unit,dsm.DSNo,im.Discount,ps.PONo,Un.Unit,iu.IssFactor,iu.PurFactor,Uni.Unit,
iu.RecpFactor,i.ItemCode,UT.Unit,iu.PkFactor,
idc.Unit,ipl.ParLevel,idc.Rate,idc.Qty
