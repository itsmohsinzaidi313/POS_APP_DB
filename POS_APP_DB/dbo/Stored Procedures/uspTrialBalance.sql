create proc [dbo].[uspTrialBalance]--'2013-08-26 00:00:00.000' ,2
@DateTo as datetime,
@COId as int
as
...
Cast(isnull([dbo].funcTrialBalanceCredit(Cast(isnull([dbo].funcGetNetBalanceByDate(ca.CAId,@DateTo,@COId),0) as decimal(18,2)),ca.AccNature),0) as decimal(18,2)) as Credit,@DateTo as DateTo
