...
CREATE Proc [dbo].[ReportCateVendorWiseReport]--'7/1/2013 12:00:00 AM','7/9/2013 12:00:00 AM','Admin','9'
@From as datetime,
@To as Datetime,
...
isnull([dbo].funcGetItemAvgRateInvoice(im.InvoiceId,i.ItemId,idc.Unit),0) as UnitPrice,
