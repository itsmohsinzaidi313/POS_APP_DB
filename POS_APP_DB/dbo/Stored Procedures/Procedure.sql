...
AS
	...
	open cOnSpotDeals
	fetch next into @dealId, @dealName, @dealQty, @dealPrice, @categoryName, @dealComment
	...
	begin
		...
		insert into DealsOnSpotItems(Order_Key, Order_detailId, Deal_name, deal_Price, qty, Department, Category_name, Item_name, ItemQty, Price_Item, item_comment)
		select 
		@OrderKey,
		@orderDetailId,
		...
		(t.c.value('../../@Quantity','float') * /*dealQuantity*/
