...
CREATE Proc [dbo].[ReportItemWisePurchaseReport]--'6/27/2013 12:00:00 AM','7/27/2013 12:00:00 AM','Admin','33'
@From as datetime,
@To as Datetime,
...
set @ReportName='Goods Purchasing Item wise';
...
iu.RecpFactor,UT.Unit,iu.PkFactor,
idc.Unit,
--ipl.ParLevel,
idc.Rate,idc.Qty,s.SId,i.ItemId
