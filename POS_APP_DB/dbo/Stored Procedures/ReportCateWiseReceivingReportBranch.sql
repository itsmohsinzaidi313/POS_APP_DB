...
CREATE Proc [dbo].[ReportCateWiseReceivingReportBranch]--'6/26/2013 12:00:00 AM','6/29/2013 12:00:00 AM','Admin','10'
@From as datetime,
@To as Datetime,
...
set @ReportName='Goods Receiving Branch Category Wise';
select CONVERT(VARCHAR(11),@From,106) as [From],CONVERT(VARCHAR(11),@To,106) as [To],@Login as LoginUser,gm.Date,gm.GRNo,v.Vendor,@ReportName as Branch,c.Category,sc.Subcategory,i.Item,
