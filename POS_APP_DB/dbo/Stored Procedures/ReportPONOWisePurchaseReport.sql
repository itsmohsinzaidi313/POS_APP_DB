...
CREATE Proc [dbo].[ReportPONOWisePurchaseReport]--'6/26/2013 12:00:00 AM','6/26/2013 12:00:00 AM','Admin','28'
@PONoId as text,
...
idc.TotalPackage,idc.PcsPerPackage as UnitQty,v.Address,v.CellNo,
...
inner join Split(@PONoId,',') sp on sp.items =ps.POId
--where ipl.SId>0   and ipl.BRId=0
...
idc.Unit,
--ipl.ParLevel,
idc.Rate,idc.Qty,v.Address,v.CellNo,i.ItemId,s.SId
