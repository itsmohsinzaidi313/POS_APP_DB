CREATE proc [dbo].[uspGetBUTReturnCode] 
@SId as int
as
...
set @TableName = 'ButcheryReturnMaster';
set @VoucherPara= 'BUR-';

SET @SQLString= 'select @NewVoucher = isnull(Max(BURNo),0) from '+@TableName+' where SId =''' + CONVERT(VARCHAR(10),@SId , 101) + '''';
