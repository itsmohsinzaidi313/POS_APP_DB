CREATE proc [dbo].[ItemTrunOverPurchaseConsumptionTwo]--'09/01/13','9/30/13','45,46,48,49,50,51'
@From as datetime,
@To as Datetime,
@ItemId as text
as
...
(select Isnull(sum(psd.IngredientAmount),0)
