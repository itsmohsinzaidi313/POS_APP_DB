...
CREATE Proc [dbo].[ReportDateWiseIssuanceReturn]--'12/01/2013 12:00:00 AM','12/30/2013 12:00:00 AM','Admin','30'
@From as datetime,
@To as Datetime,
@Login as nvarchar(max)
as
Declare @ReportName as nvarchar(max);
set @ReportName='Branch Issuance Return Date Wise';
select CONVERT(VARCHAR(11),@From,106) as [From],CONVERT(VARCHAR(11),@To,106) as [To],@Login as LoginUser,
ism.Date,ism.IssRNo,@ReportName as store,Un.Unit as branch,c.Category,sc.Subcategory,i.Item,U.Unit as PackingType,
