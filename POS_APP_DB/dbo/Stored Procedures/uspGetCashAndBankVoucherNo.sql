CREATE proc [dbo].[uspGetCashAndBankVoucherNo]
@Type as nvarchar(10)
as
...
if @Type = 'Cash'
begin 
set @TableName = 'CashPaymentMaster';
set @VoucherPara= 'CPV-';
...
begin 
set @TableName = 'BankPaymentMaster';
set @VoucherPara= 'BPV-';
SET @SQLString= 'select @NewVoucher = isnull(Max(VN),0) from '+@TableName+' ';
Set @ParamDefination=N'@NewVoucher varchar(50) OUTPUT'
exec sp_executesql @SQLString,@ParamDefination,@NewVoucher=@NewVoucher OUTPUT
...
if @Type = 'Cash'
begin 
set @NewVoucher = 'CPV-0001'
set @NewVoucherCode= @NewVoucher 
end
else if  @Type = 'bank'
begin
set @NewVoucher = 'BPV-0001'
set @NewVoucherCode= @NewVoucher 
end
End
else 
